    ...
    public class KeyValueFile {
        ...
        public string Data {
            ...
            private set {
                ...
                if(AutoSort && _doSort) SortAlphabetic(AutoSortDescending);
            }
        }

        private FileEntry File {
            get {
                Folder folder = OS.thisComputer.getFolderFromPath(_path, true);
                FileEntry file;
        ...
        public bool Add(KeyValuePair<string, string> pair) {
        ...
        public static string ToKeyValueString(KeyValuePair<string, string> pair) {
            return pair.Key + "='" + pair.Value + Delimiter;
        }
        ...
        public static KeyValuePair<string, string> ToKeyValuePair(string text) {
            if(!string.IsNullOrWhiteSpace(text)) {
                ...
                string value = text.Substring(text.IndexOf('=') + 1).Trim(Delimiter);
